...
vape.Libraries.string = loadstring(downloadFile('bananavxpe/libraries/string.lua'), 'string')()
...
local hash = loadstring(downloadFile('bananavxpe/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('bananavxpe/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('bananavxpe/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('bananavxpe/profiles/whitelist.json') and readfile('bananavxpe/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('bananavxpe/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('bananavxpe/assets/new/radaricon.png'),
...
run(function()
    ...
    local function Added(ent)
    	...
    	arrow.Visible = false
    	arrow.Image = getcustomasset('bananavxpe/assets/new/arrowmodule.png')
